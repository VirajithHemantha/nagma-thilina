...
const images = [
  { id: 1, url: '/a.jpg', position: 'object-top', fallback: 'https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=80&w=800&auto=format&fit=crop', title: 'The Beginning' },
  { id: 2, url: '/b.jpg', position: 'object-[center_30%]', fallback: 'https://images.unsplash.com/photo-1522673607200-164d1f624698?q=80&w=800&auto=format&fit=crop', title: 'Our Journey' },
  { id: 3, url: '/c.jpg', position: 'object-bottom', fallback: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?q=80&w=800&auto=format&fit=crop', title: 'A Thousand Words' },
  { id: 4, url: '/d.jpg', position: 'object-[center_30%]', fallback: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?q=80&w=800&auto=format&fit=crop', title: 'Endless Love' },
  { id: 5, url: '/f.jpg', position: 'object-[center_30%]', fallback: 'https://images.unsplash.com/photo-1519225421980-715cb02151ff?q=80&w=800&auto=format&fit=crop', title: 'Forever Together' },
];
      ...
      >
        <div className="animate-marquee gap-6 sm:gap-10 px-6 sm:px-10 pb-16 pt-4 items-center cursor-ew-resize">
          {marqueeImages.map((image, index) => (
            <div
              key={`${image.id}-${index}`}
              className="relative flex-none w-[85vw] sm:w-[55vw] lg:w-[40vw] aspect-[4/3] sm:aspect-[3/2] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.1)] group cursor-pointer border-[8px] sm:border-[10px] border-white/90 bg-brand-champagne transform transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_40px_60px_rgba(197,160,89,0.2)]"
            ...
            >
              <img
                ...
                alt={image.title}
                className={`w-full h-full object-cover transition-transform duration-[2s] ease-out group-hover:scale-110 ${image.position || 'object-center'}`}
              />
