          ...
          <div className="lg:w-1/2 relative z-10 w-full">
            ...
            >
              ...
              <p className="text-stone-500/90 font-serif text-lg sm:text-xl leading-relaxed mb-16 max-w-lg">
                A celebration of tradition and love. Join us for a beautiful morning ceremony followed by a joyful day of dining, blessings, and celebration from 9:00 AM to 4:00 PM.
              ...
              <div className="relative space-y-10 ml-10 sm:ml-12 border-l-[1.5px] border-poruwa-primary/40 pl-10 sm:pl-12 py-4">
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">Wednesday, July 22, 2026</h4>
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">The Epitome Hotel, Kurunegala</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">09:00 AM</h4>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-poruwa-primary transition-colors duration-500">09:04 AM</h4>
